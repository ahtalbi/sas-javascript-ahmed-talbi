 ...
 * 2. Vérifiez si l'utilisateur est éligible : la mensualité estimée (montantEmprunte / dureeEnMois) 
 *    ne doit pas dépasser 30% de son revenuMensuel.
 * 3. S'il est éligible, affichez "Prêt accordé. Mensualité : [X] MAD".
 * 4. S'il n'est pas éligible, mais que son revenu est supérieur à 10000 MAD,
 *    proposez d'augmenter la durée. Sinon, affichez "Prêt refusé".
 *
...
if (mensualite > (revenuMensuel * 0.30)) {
    if (mensualite > 10000) {
        console.log("Proposition de changer la dure.");
    } else {
